        ...
        <div className="card">
          ...
          <form className="row" onSubmit={addSingle}>
            ...
            <div style={{ gridColumn: 'span 2' }}>
              ...
              <input className="input" name="unit_cost" type="number" step="0.01" required />
            </div>
            <div style={{ gridColumn: 'span 2' }}>
              <label>Qty</label>
              <input className="input" name="qty_on_hand" type="number" step="1" required />
            </div>
